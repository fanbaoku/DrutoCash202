...
import com.cash.ease.money.cashease.utils.LanguageUtil.getUpdatedResourcesContext
...
open class BaseAppCompatActivity : AppCompatActivity() {
    ...
    private val mLocationListener = LocationListener { location: Location ->
        ...
        CashEaseApplication.LOCATION_LIVE_DATA.postValue(location)
    }
        ...
        override fun run() {
            if (ActivityCompat.checkSelfPermission(
                ...
                if (lastKnownLocation != null) {
                    ...
                    CashEaseApplication.LOCATION_LIVE_DATA.postValue(lastKnownLocation)
                }
